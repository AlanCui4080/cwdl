...
class CWModel(nn.Module):
    ...
    def __init__(self, vocab_size: int):
        ...
        self.cnn = nn.Sequential(
            ...
            nn.Conv2d(32, 64, kernel_size=3, stride=(4, 1), padding=(0, 1),
                      bias=False),
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
        )

        self.conv1d_1 = nn.Conv1d(64, 128, 3, dilation=1, padding=1, bias=False)
        self.conv1d_2 = nn.Conv1d(128, 128, 3, dilation=2, padding=2, bias=False)
        self.conv1d_3 = nn.Conv1d(128, 128, 3, dilation=4, padding=4, bias=False)
        self.conv1d_4 = nn.Conv1d(128, 128, 3, dilation=8, padding=8, bias=False)
    ...
    def forward(self, blocks: torch.Tensor,
        ...
        x = self.relu(self.bn4(self.conv1d_4(x)))
